...
class RostersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create roster" do
    assert_difference('Roster.count') do
      post rosters_url, params: { roster: { first_name: @roster.first_name, last_name: @roster.last_name, role: @roster.role } }
    end
  ...
  test "should update roster" do
    patch roster_url(@roster), params: { roster: { first_name: @roster.first_name, last_name: @roster.last_name, role: @roster.role } }
